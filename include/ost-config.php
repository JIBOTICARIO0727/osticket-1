...
define('SECRET_SALT','lSOI4UJI5UOtM0L050WwbgouWz21qMdi');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','angelo.mogul@yahoo.com');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','osticket-mysql-db.mysql.database.azure.com');
define('DBNAME','osticket_db');
define('DBUSER','rtspdevs');
define('DBPASS','123Qwe1!');
